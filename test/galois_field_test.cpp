...
TEST_CASE("Galois field") {
  SUBCASE("multiply by 2") {
    REQUIRE_EQ(raid_fs::galois_field::Element::byte_multiply_by_2(2), 4);
    REQUIRE_EQ(raid_fs::galois_field::Element::byte_multiply_by_2(4), 8);
    REQUIRE_EQ(raid_fs::galois_field::Element::byte_multiply_by_2(8), 16);
